...
public class Calculator extends VBox implements EventHandler<ActionEvent>{
    ...
    public String numeros(String num){
        if (numero1.isEmpty()){
        	numero1 = num;
        	operador="";
        } else {
    ...
    public String operadores(String op){
        operador = op;
        return numero1 + operador + numero2;
    }
    
    public float operar(String s){
        float NUMERO1 = Character.getNumericValue(s.charAt(0));
        float NUMERO2 = Character.getNumericValue(s.charAt(2));
        switch (s.charAt(1)) {
            case '*':
	...
	public void handle(ActionEvent event) {
        ...
        switch (dato) {
        case "0":
            displayText.setText(numeros(dato));
            break;
        case "1":
            displayText.setText(numeros(dato));
            break;
        ...
        case "9":
            ...
            break;
        case "/":
            displayText.setText(operadores(dato));
            break;
        case "*":
            displayText.setText(operadores(dato));
            break;
